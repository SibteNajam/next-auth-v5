...
const Header: FC<any> = ({ onToggleSidebar, isSidebarOpen }: HeaderProps) => {
  ...
  return (
    ...
    //               style={{ width: "100%" }}
    //               id="dropdownMenu"
    //               className="signin-dropdown absolute block shadow-lg bg-white py-2 z-[1000] min-w-full w-max rounded-lg max-h-96 overflow-auto"
    //             >
    ...
    <nav className="main-header-container bg-white border-b border-gray-200 shadow-sm">
      <ToggleIcon
        onClick={onToggleSidebar}
        className={` header-icon transition-transform duration-200 ${
          isSidebarOpen ? "rotate-180" : ""
